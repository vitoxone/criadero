<?php
$this->Html->addCrumb('Colores', array('controller' => 'colors', 'action' => 'index'));
$this->Html->addCrumb('Agregar Color');
?>
...
<div class="col-lg-9">
<?php echo $this->Form->create('Color', array('class' => 'form-vertical')); ?>
<br />
