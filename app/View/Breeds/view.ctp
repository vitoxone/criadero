...
<h2><?php echo __('Breed'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($breed['Breed']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($breed['Breed']['name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Breed'), array('action' => 'edit', $breed['Breed']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Breed'), array('action' => 'delete', $breed['Breed']['id']), null, __('Are you sure you want to delete # %s?', $breed['Breed']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Breeds'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Breed'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php foreach ($breed['Horse'] as $horse): ?>
		<tr>
